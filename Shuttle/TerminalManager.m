...
- (void)executeInTerminalDirectly:(NSString *)command windowMode:(WindowMode)windowMode theme:(NSString *)theme title:(NSString *)title {
    NSString *escapedCommand = [self escapeShellCommand:command];
    NSString *escapedTheme = [self escapeShellCommand:theme ?: @"Basic"];
    NSString *escapedTitle = [self escapeShellCommand:title ?: @"Shuttle"];
